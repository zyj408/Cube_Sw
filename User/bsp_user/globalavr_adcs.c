...
double     upAdcsWhlV;                   /*动量轮角动量控制电压，姿控使用*/
double     upXwAdcsWhlV;                 /*动量轮角动量控制电压，数据综合放上行指令*/
enum BOOL  upXwAdcsWhlVFlag;             /*动量轮角动量控制电压，数据综合置位*/
...
enum BOOL  upXwAdcsDmpForever;           /*永久阻尼标志，等上行指令清零*/

enum BOOL  upXwAdcsDmpFlg;               /*上行阻尼标志位，对应姿控magDotDmpFlg*/
enum BOOL  upXwAdcsDmpFlgFlag;           /*阻尼标志位，数据综合置位*/
 
enum BOOL  upXwAdcsFltFlg;               /*上行测量标志位，对应姿控pitFltComFlg*/

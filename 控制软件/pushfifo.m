...
%%
    ...
    if isempty(ad_fifo1)
        ad_fifo1 = zeros([1,100]);
    end
    if isempty(ad_fifo2)
        ad_fifo2 = zeros([1,100]);
    end
    if isempty(ad_fifo3)
        ad_fifo3 = zeros([1,100]);
    end
    if isempty(ad_fifo4)
        ad_fifo4 = zeros([1,100]);
    end
    if isempty(ad_fifo5)
        ad_fifo5 = zeros([1,100]);
    end
    if isempty(ad_fifo6)
        ad_fifo6 = zeros([1,100]);
    end
    if isempty(ad_fifo7)
        ad_fifo7 = zeros([1,100]);
    end
    if isempty(ad_fifo8)
        ad_fifo8 = zeros([1,100]);
    end
    if isempty(ad_fifo9)
        ad_fifo9 = zeros([1,100]);
    end
    if isempty(ad_fifo10)
        ad_fifo10 = zeros([1,100]);
    end
    if isempty(ad_fifo11)
        ad_fifo11 = zeros([1,100]);
    end
    if isempty(ad_fifo12)
        ad_fifo12 = zeros([1,100]);
    end
    if isempty(ad_fifo13)
        ad_fifo13 = zeros([1,100]);
    end
    if isempty(ad_fifo14)
        ad_fifo14 = zeros([1,100]);
    end
    if isempty(ad_fifo15)
        ad_fifo15 = zeros([1,100]);
    end
    if isempty(ad_fifo16)
        ad_fifo16 = zeros([1,100]);
    end
%%
    if num == 1
    for i = 1 : (100 - 1)
